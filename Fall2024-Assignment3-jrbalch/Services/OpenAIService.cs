...
namespace Fall2024_Assignment3_jrbalch.Services
{
    public class OpenAIService
    {
        ...
        public async Task<List<string>> GenerateReviewsAsync(string reviewee) {
            ...
            {
                new SystemChatMessage("You are a movie reviewer. Write 20 short reviews for the given movie, and give each a star rating out of 5. Please separate each review with '###' so they can be easily parsed."),
                new UserChatMessage($"The movie title is '{reviewee}'. Please write reviews for this movie.")
            };
